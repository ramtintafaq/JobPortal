...
import it.tafaq.springboot.jobportal.entity.*;
import it.tafaq.springboot.jobportal.services.JobPostActivityService;
import it.tafaq.springboot.jobportal.services.JobSeekerApplyService;
import it.tafaq.springboot.jobportal.services.JobSeekerSaveService;
import it.tafaq.springboot.jobportal.services.UsersService;
...
public class JobPostActivityController {
    ...
    public String addNew(JobPostActivity jobPostActivity, Model model) {
        ...
        jobPostActivity.setPostedDate(Date.from(new Date().toInstant()));
